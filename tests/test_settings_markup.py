...
class SettingsMarkupTest(unittest.TestCase):
    def test_settings_page_uses_visual_target_structure(self) -> None:
        ...
        self.assertIn("语音服务 Key", INDEX_HTML)
        self.assertIn("ASR / TTS 使用", INDEX_HTML)
        self.assertIn("思考模型 Key", INDEX_HTML)
        self.assertIn("通讯员 / Agent 回复使用", INDEX_HTML)
        self.assertIn('id="thinkingApiKey"', INDEX_HTML)
        self.assertIn("ark_api_key", INDEX_HTML)
        self.assertIn("语音与思考分开检查", INDEX_HTML)
        ...
        self.assertIn("Agent Runtime", INDEX_HTML)
        self.assertIn('id="agentRuntimeLog"', INDEX_HTML)
        self.assertIn('id="agentPromptLog"', INDEX_HTML)
        self.assertIn('id="agentPermissionState"', INDEX_HTML)
        self.assertIn('id="agentSessionFileState"', INDEX_HTML)
        self.assertIn("refreshAgentRuntimeStatus", INDEX_HTML)
        self.assertIn("postAgentNewSession", INDEX_HTML)
        self.assertIn("postAgentDeleteSession", INDEX_HTML)
        self.assertIn("/api/agent/session/new", INDEX_HTML)
        self.assertIn("/api/agent/session/delete", INDEX_HTML)
        self.assertIn("copyAgentSessionPath", INDEX_HTML)
        self.assertIn("/api/agent/status", INDEX_HTML)
